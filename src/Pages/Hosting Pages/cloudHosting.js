    ...
    <div className="container">
      <div className="row justify-content-center mb-5 pb-3">
        <div className="col-md-7 text-center heading-section ftco-animate">
          <h2 className="mb-4">Our Best Pricing in Cloud  Hosting</h2>
          <p>
              ...
              <div className="col-md-6">
                <div className="card">
                  <div className="card-header">
                    ...
                    >
                      What is your Cloud  domain name?{" "}
                ...
                <div className="card">
                  <div className="card-header">
                    ...
                    >
                      How long is my Cloud  domain name valid?{" "}
                      <span className="collapsed">
                        <i className="icon-plus-circle" />
                      </span>
                      <span className="expanded">
                ...
                <div className="card">
                  <div className="card-header">
                    <Link
                      ...
                      aria-controls="menu3"
                    >
                      Can I sell my Cloud  domain name?{" "}
                      <span className="collapsed">
                        <i className="icon-plus-circle" />
                      </span>
                      <span className="expanded">
                ...
                <div className="card">
                  <div className="card-header">
                    <Link
                      ...
                      aria-controls="menu5"
                    >
                      How do I transfer a Cloud  domain name?{" "}
                      <span className="collapsed">
                        <i className="icon-plus-circle" />
                      </span>
                      <span className="expanded">
